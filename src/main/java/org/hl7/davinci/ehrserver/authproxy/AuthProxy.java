...
public class AuthProxy {
  ...
  private String _parseRedirect(Map<String, String> reqParamValue, HttpServletRequest request) {
    ...
    String finalRedirectURI = "http://" + ((System.getenv("DOCKER_DEV_PROFILE").equals("true")) && Config.get("auth_redirect_host") != null ? Config.get("auth_redirect_host") : request.getLocalName()) + ":" + request.getLocalPort() + "/test-ehr/_auth/" + reqParamValue.get("launch") + "?redirect_uri=" + currentRedirectURI;
